<template>
    <div>
            ...
            <div class="py-container">
                ...
                <div class="bread">
                    ...
                    <ul class="fl sui-tag">
                        ...
                        <li class="with-x" v-for="  (pro,index) in searchParams.props" :key="index" v-show="pro">
                            {{pro.split(":")[1]}}<i @click="removepro(index)">×</i>
                        </li>
                    </ul>
                </div>

                <!--selector-->
                <SearchSelector @trademarkInfo="trademarkInfo" @typelist="typelist"> </SearchSelector>
                ...
                <div class="details clearfix">
                    <div class="sui-navbar">
                        <div class="navbar-inner filter">
                            <ul class="sui-nav">
                                <li :class="{active:isOne}" @click="zh">
                                    <a href="#">综合<span v-show='isOne' class=" iconfont "
                                            :class="{'icon-up':up,'icon-down':down}"></span></a>
                                </li>

                                <li :class="{active:isTwo}" @click="xl">
                                    <a href="#">销量<span v-show='isTwo' class=" iconfont"
                                            :class="{'icon-up':up,'icon-down':down}"></span></a>
                                </li>
        ...
        <button @click="test">eqweqw</button>
    </div>
</template>
    ...
    export default {
        ...
        watch: {
            $route(newValue, oldValue) {
                ...
                // 因为query和params是存在route中的,若query或params更改未更改就会拿之前的来继续用
            }
        },
        ...
        methods: {
            ...
            getPageNo(pageNo, totalpages) {

                this.searchParams.pageNo = pageNo
                if (this.searchParams.pageNo < 1) {
                    this.searchParams.pageNo = 1
                }
                if (this.searchParams.pageNo > totalpages) {
                    this.searchParams.pageNo = totalpages
                }
                this.getData()
            ...
            zh() {
                ...
                switch (this.searchParams.order == '1:desc') {
                    case true:
            ...
            xl() {
                switch (this.searchParams.order == '2:desc') {
                    case true:
            ...
            removeaddts() {
                this.searchParams.attrs = undefined,
                    this.getData()

            },
            typelist(attrs, attrValue) {
            ...
            getData() { this.$store.dispatch('searchList', this.searchParams) },
            removeCategoryName() {
        ...
        computed: {
            ...
            */
            /*  ...mapGetters({
                  goodsList: 'goodsList', attrsList: 'attrsList', trademarkList: 'trademarkList'
                  // 此处对象方式无法写简写形式，简写形式只能写成数组
              })*/
        },
